...
#pragma region FBX
	{
		shared_ptr<_2B_Player> Player = make_shared<_2B_Player>();
		Player->Awake();
	}
#pragma endregion	
...
void TestScene::RenderDeferred()
{
	Scene::RenderDeferred();
}

void TestScene::RenderLights()
{
	Scene::RenderLights();
}

void TestScene::RenderFinal()
{
	Scene::RenderFinal();
}
